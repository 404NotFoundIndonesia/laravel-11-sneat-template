      ...
      <div class="authentication-inner py-4">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="mb-4">Silakan masukkan password baru kamu</p>
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('password.store') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $request->email) }}" id="email" name="email" required placeholder="Masukkan email" />
                ...
                <button class="btn mt-4 btn-primary d-grid w-100" type="submit">Reset Password</button>
            </form>
          </div>
        </div>
        <!-- /Forgot Password -->
